...
{
    private static Dictionary<Material, Material> convertedMaterials = new Dictionary<Material, Material>();
    ...
    private static void ConvertMaterial()
    {
        ...
        // Apply the converted materials to the SkinnedMeshRenderers
        ApplyConvertedMaterials();
    ...
    private static void CreatePoiyomiMaterial(ref Material lil, bool isPro)
    {
        ...
        // Store the converted material in the dictionary
        convertedMaterials[lil] = poi;
    }

    private static void ApplyConvertedMaterials()
    {
